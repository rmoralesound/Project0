...
//==============================================================================
const juce::String Project0AudioProcessor::getName() const
{
...
const juce::String Project0AudioProcessor::getProgramName (int index)
{
    return {};
}

void Project0AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void Project0AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* Project0AudioProcessor::createEditor()
{
    return new Project0AudioProcessorEditor (*this);
}

//==============================================================================
void Project0AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
